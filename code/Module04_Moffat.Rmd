...
ggplot(
data = penguins,
# this step will assign values to x and y axes
...
# geom: the geometrical object that a plot uses to represent data. People often describe plots by the type of geom that the plot uses. (example: bar plots utilise bar geoms geom_bar)
# Here we are using geom_point to add a layer of points to the plot to create a scatterplot
```{r}
ggplot(
  data = penguins,
  mapping = aes(x = flipper_length_mm, y = body_mass_g)
